...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240115132637_MortgagesTable1")]
    partial class MortgagesTable1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.Mortgage", b =>
                {
                    b.HasOne("Core.Entities.Customer", "CustomerEntitys")
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Entities.Property", "PropertyEntitys")
                        .WithMany()
